-- Xyneria wrapper layer.
-- Appended to a locally vendored WindUI core by build/build.py.
-- There is intentionally NO CORE_URL and no WindUI download here.
--
-- WindUI copyright (c) 2026 Footages, MIT licensed.
-- See LICENSES/WindUI-MIT.txt and THIRD_PARTY_NOTICES.md.
...
XyneriaUI.UpstreamWindUIVersion = "1.6.66"
